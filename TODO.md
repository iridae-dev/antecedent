...
6. **Mechanism families and Bayesian gaps** (DESIGN.md §14.4, §16, §18.4, §12): Largest multi-backend bundle.
    ...
    ESS/SBC wait on HMC/SMC backends; overlaps optional feature flags in item 1. External Stan/PyMC adapters are **not** required for completion (native Laplace is canonical; see DESIGN §14.5).
