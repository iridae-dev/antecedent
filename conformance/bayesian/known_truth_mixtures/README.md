...
1 + 2.46875t`, with 0.2 unidentified mass kept separate. Multi-atom response
uncertainty is declared unavailable, so this is a numeric pin, not a coverage
claim. The Frequentist tolerance (0.05) absorbs the smoothing error of the
