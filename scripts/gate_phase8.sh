...
EVIDENCE = {
    ...
    "pag.graph.latent_projection": "crates/causal/tests/phase8_pag.rs",
    "pag.graph.completions_streamed": "crates/causal-graph/src/completion.rs",
    "pag.identify.generalized_adjustment": "crates/causal/tests/phase8_pag.rs",
    "pag.discovery.lpcmci": "crates/causal/tests/phase8_pag.rs",
    "pag.facade.dag_only_reject": "crates/causal/tests/phase8_pag.rs",
