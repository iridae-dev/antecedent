...
**Suite path:** `conformance/response/temporal_soft_mean_mechanisms`
...
Top-level keys: `atol, cases, feature, generation, nondegenerate_counterexample, python_reduced_graph, semantics` (7 fields).
