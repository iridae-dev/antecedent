# Security, licensing, unsafe-code, and dependency review (Phase 12)

Date: 2026-07-21  
Scope: workspace crates + `python` extension (package version **0.1.0**)  
ADR: [0017](../adr/0017-phase12-1.0-prep.md)

## Unsafe code policy

| Crate | Policy | Notes |
|-------|--------|-------|
| All semantic crates (`causal-*` except kernels) | `#![forbid(unsafe_code)]` | Verified by `scripts/gate_phase12.sh` |
...
| `pyo3` 0.29 / `numpy` 0.29 | Python boundary | Upgraded in Phase 12 to clear `RUSTSEC-2025-0020` and `RUSTSEC-2026-0177` |
