...
explicit stage contracts. Package version **1.2.0**.
...
| [1.2.0 release notes](release-notes/v1.2.0.md) | New compatible cells, query-native validation, and posterior evidence |
