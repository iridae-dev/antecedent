...
use antecedent_expr::{CausalExprArena, EstimandMethod, ExprNode, IdentifiedEstimand};
use antecedent_graph::{Admg, BitSet, DSeparationWorkspace, Dag, DenseNodeId};
...
enum IdcOk {
    Identified { functional: antecedent_expr::ExprId, arena: CausalExprArena },
