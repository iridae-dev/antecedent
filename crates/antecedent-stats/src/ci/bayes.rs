...
use antecedent_kernels::{ParCorrMode, ParCorrQuery, partial_correlation_batch, standard_normal};
...
fn residualize_one(
    ...
    if q.z_len == 0 {
        ...
        let r = antecedent_kernels::pearson(&workspace.parcorr.rx[..n], &workspace.parcorr.ry[..n])
            .unwrap_or(0.0);
