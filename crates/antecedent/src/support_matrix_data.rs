...
pub static NA_RULES: &[NaRule] = &[
    ...
    NaRule {
        queries: Some(&["AverageDerivative", "AverageEffect", "ConditionalEffect", "Counterfactual", "DirectionalDerivative", "Elasticity", "InterventionalDistribution", "PathSpecificEffect", "PointDerivative", "ResponseJacobian", "SemiElasticity"]),
    ...
    NaRule {
        ...
        inferences: None,
        validations: None,
        reason: "Temporal response is licensed only on TemporalDag; CPDAG/PAG temporal response has no class-aware identifier.",
    },
    NaRule {
