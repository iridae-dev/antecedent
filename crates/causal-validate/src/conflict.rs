...
use causal_estimate::PreparedBayesianProblem;
use causal_prob::{
...
/// Attach a [`ConflictSummary`] onto a [`causal_estimate::CausalPosterior`].
#[must_use]
pub fn with_conflict_summary(
    mut posterior: causal_estimate::CausalPosterior,
    summary: ConflictSummary,
) -> causal_estimate::CausalPosterior {
...
/// # Errors
///
/// Composition failures from `causal-prob`.
...
mod tests {
    use super::*;
    use causal_prob::{ExternalPriorWeight, GaussianCoefficientPrior, PriorSpec};
