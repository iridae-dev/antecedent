//! Phase 12 artifact migration conformance.
//!
...
fn fixture_dir() -> PathBuf {
    PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../../conformance/phase12/artifact_migrate")
}
...
fn schema_graph_artifact() -> EncodedArtifact {
    ...
    EncodedArtifact {
        manifest: ArtifactManifest {
            ...
            provenance: ProvenanceWire { note: "phase12".into() },
        },
        sections: vec![
