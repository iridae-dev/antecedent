//! Tigramite PCMCI lag-1 conformance (`Exact` edge set).
//!
...
fn fixture_dir() -> PathBuf {
    PathBuf::from(env!("CARGO_MANIFEST_DIR")).join("../../conformance/tigramite/pcmci_lag1")
}
...
#[test]
fn tigramite_pcmci_lag1_exact_parents() {
