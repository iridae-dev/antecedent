//! J-PCMCI+ two-env black-box edge-set equality vs Tigramite.
//!
...
fn fixture_dir() -> PathBuf {
    PathBuf::from(env!("CARGO_MANIFEST_DIR"))
        .join("../../conformance/tigramite/jpcmci_plus_two_env_edges")
}
...
#[test]
fn tigramite_jpcmci_plus_two_env_edge_equality() {
