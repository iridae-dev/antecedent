...
//!
//! Contrast generation lives in `antecedent-data`; provenance records live on
//! [`antecedent_stats::CompiledDesign`].
//!
...
mod tests {
    ...
    use antecedent_data::{CategoryDomain, CategoryLevel, Contrast, compile_contrast_matrix};
    ...
    fn two_level_domain() -> CategoryDomain {
        CategoryDomain::try_new(
            ...
            antecedent_data::UnknownCategoryPolicy::Fail,
        )
        .unwrap()
    }
