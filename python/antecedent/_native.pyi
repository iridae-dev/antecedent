...
class PreparedAnalysis:
    def snapshot(self) -> PreparedAnalysis: ...
    def execution_contract(self) -> dict[str, str]: ...
    def estimate_bound(self, *, seed: int = 1, threads: int = 1) -> AteAnalysisResult: ...
    def estimate_response_bound(self, *, seed: int = 1, threads: int = 1) -> ResponseAnalysisResult: ...
    @staticmethod
